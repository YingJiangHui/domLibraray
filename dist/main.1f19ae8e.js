...
var div = dom.create('<div><h2>标题</h2><p>这是一段文字</p><p>这是第二段文字</p></div>');
var p = dom.create("<p>这是第三段文字</p>");
dom.append(document.body, div);
dom.append(div, p);
console.log();
dom.remove(p);
var wrap = dom.create('<div class="wrap"></div>');
dom.wrap(div, wrap); // console.log(dom.empty(div))
// dom.empty(div);
...
},{}]},{},["C:/Users/111/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
